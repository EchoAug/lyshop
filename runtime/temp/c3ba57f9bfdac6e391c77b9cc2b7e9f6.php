<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\PHPStudyE\WWW\lyshopV2.2\public/../application/admin\view\brige\adpayedpage.html";i:1518072414;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
	$(function(){
        ...
        $("#send_ad").click(function () {
            ...
            ads = ads.split(',');
            console.log(ads);
            $.post("<?php echo url('Brige/payedAdGrant'); ?>", {"ads": ads, "id": id}, function (res) {
                if (res == 1) {
