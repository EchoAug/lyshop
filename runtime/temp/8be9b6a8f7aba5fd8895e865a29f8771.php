<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\PHPStudyE\WWW\lyshopV2.2\public/../application/admin\view\brige\index.html";i:1518071864;s:79:"C:\PHPStudyE\WWW\lyshopV2.2\public/../application/admin\view\Public\header.html";i:1518229341;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td style="width: 15%;">
                ...
                <a class="operation-icon" title="分配广告" onclick="admin_full_show('分配广告','<?php echo url("Brige/adPage",["bid" => $vo['brige_id']]); ?>')"
                href="javascript:;">
                <img style="width: 16px;vertical-align: top; " src="__STATIC__/images/ads.png"/>
                </a>
                <a class="operation-icon" title="分配支付完成广告" onclick="admin_full_show('分配支付完成广告','<?php echo url("Brige/adPayedPage",["bid" => $vo['brige_id']]); ?>')"
                href="javascript:;">
