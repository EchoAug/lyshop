<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"C:\PHPStudyE\WWW\lyshopV2.2\public/../application/admin\view\ad\index.html";i:1518230052;s:79:"C:\PHPStudyE\WWW\lyshopV2.2\public/../application/admin\view\Public\header.html";i:1518229341;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//            console.log(select_ads);
            //需要修改此处的连接网址
            admin_full_show('配置广告', Config.settingAdURL + select_ads);
            return false;
        });
    });
