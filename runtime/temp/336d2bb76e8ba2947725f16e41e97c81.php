<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpStudy\WWW\lyshopV2.1\public/../application/admin\view\ad\index.html";i:1517451971;s:78:"D:\phpStudy\WWW\lyshopV2.1\public/../application/admin\view\Public\header.html";i:1510801998;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    <xblock>
        <span style="color: palevioletred;font-weight: bold;margin-left: 20px;">
            广告如果删除后,请根据图片存放地址删除资源。(删除图片并没有删除图片源)
        </span>
        <div>
            <hr class="layui-bg-green">
            <button class="layui-btn layui-btn-small layui-btn-radius layui-btn-primary"
                    onclick="admin_full_show('广告图片添加','<?php echo url("Ad/create"); ?>')">
            添加广告 </button>
...
//            console.log(select_ads);
            //需要修改此处的连接网址
            admin_full_show('配置广告', 'http://www.localhost.cc/lyshopV2.1/public/admin/ad/allotad/ads/' + select_ads);
            return false;
        });
    });
    ...
    var open_tips = function () {
        layer.tips('对所有冰箱进行批量配置广告', '#allot_ad');
    }
</script>
